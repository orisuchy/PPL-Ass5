...
(display "Success yaGever - get-value\n")
...
(display "Success yaGever - collect-all-values-1 1\n")
(check-equal? (collect-all-values-1 (list l1 l2) 'k) '() "incorrect collect-all-values-1 2")
(display "Success yaGever - collect-all-values-1 2\n")
(check-equal? (collect-all-values-1 (list l1 l2) 'f) '(6) "incorrect collect-all-values-1 2")
(display "Success yaGever - collect-all-values-1 3\n")
(check-equal? (collect-all-values-2 (list l1 l2) 'e) '(2 5) "incorrect collect-all-values-2 1")
(display "Success yaGever - collect-all-values-2 1\n")
(check-equal? (collect-all-values-2 (list l1 l2) 'k) '() "incorrect collect-all-values-2 2")
(display "Success yaGever - collect-all-values-2 2\n")